...
exports.getBasicInfo = (id, options, callback) => {
  ...
  request("https://cors-anywhere.herokuapp.com/" + url, reqOptions, (err, res, body) => {
...
const gotConfig = (id, options, additional, config, fromEmbed, callback) => {
  ...
  request("https://cors-anywhere.herokuapp.com/" + url, options.requestOptions, (err, res, body) => {
    if (err) return callback(err);
